...
| **Termly**                          | **Pro+**: **Remove Termly logo**                                                                                          | **USD 15–20**/site/mo                                                                                                              | Easy (**Google** + Termly **GTM** template docs)                                          | Medium                                                                                                                 | [termly.io/pricing](https://termly.io/pricing/), [GTM article](https://support.termly.io/hc/en-us/articles/30710480660881-How-to-use-Termly-with-Google-Tag-Manager)              |
...
| Topic                                                                                                                              | Where                                                                                                           |
| ---------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **CookieYes** vs **Complianz** GTM events, **CookieYes Ultimate** branding economics, **Termly Pro+** GTM + Consent Mode deep-dive | `**docs/decisions/0002-consent-platform-selection.md`** (original matrix + **Supplement** + **Termly** section) |
| Category model (**necessary / analytics / marketing**), embed inventory                                                            | `**docs/tracking-and-consent-requirements.md`**                                                                 |
| GTM migration steps for current stack | **docs/gtm-termly-migration-runbook.md**, **docs/kpi-measurement-map.md** |
...
- **Termly Pro+ (~USD 15–20):** **WL** + **documented GTM** path + **Google** help article.
...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| **Termly** | [Trustpilot termly.io](https://www.trustpilot.com/review/termly.io) (~**4.7**/5, **hundreds** of reviews); [G2 CookieYes vs Termly](https://www.g2.com/compare/cookieyes-vs-termly) (~**4.3**/5, **~38** CMP-related reviews on G2 for Termly) | Broadly **positive**; support often praised | Trustpilot notes **paid** use of the platform; reviews mix **policies + CMP**, not CMP-only |
| **consentmanager.net** | [Trustpilot consentmanager.net](https://www.trustpilot.com/review/consentmanager.net) (~**3.9**/5, **~27** reviews); [OMR Reviews](https://omr.com/en/reviews/product/consentmanager) (~**3.9**/5, **~27**; **ease of use** / **meets requirements** often **~8**/10 in that listing) | Solid **feature** reputation; **ease of setup** often rated **high** in OMR-style breakdowns | **Fewer** English reviews than Termly; read **recent** 1★ themes yourself |
...
| **Secure Privacy** | [Trustpilot secureprivacy.ai](https://www.trustpilot.com/review/secureprivacy.ai) (~**4.8**/5, **~53** reviews) | **Strong** on **speed of setup** and **ease** in many reviews | Still **modest** N vs Termly |
...
**Interpretation:** For **review depth + CMP-relevant breadth**, **Termly** wins. **Secure Privacy** is next on **Trustpilot** quality-per-review at **mid-size** N. **consentmanager** is **credible** but with **more mixed** aggregate stars and **smaller** N. **CookieFirst** and **Enzuzo** need **trial** validation more than star averages.
...
| Need                                | Termly **Pro+**                                                                                                                                                                                                                                                                                           | consentmanager **Starter**                                                                                                   | CookieFirst **Basic+**                                                                   | Secure Privacy **Business**                       | Enzuzo **Starter+**                                        |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------- | ---------------------------------------------------------- |
| **White-label**                     | **Yes** (remove logo)                                                                                                                                                                                                                                                                                     | **Yes** (plan list)                                                                                                          | **Yes** (WL banner)                                                                      | **Yes** (WL banner tier)                          | **Yes** (remove logo from Starter in vendor copy)          |
| **GTM + Google** | **Excellent**: [Google Tag Manager Help](https://support.google.com/tagmanager/answer/14563172) + [Termly GTM guide](https://support.termly.io/hc/en-us/articles/30710480660881-How-to-use-Termly-with-Google-Tag-Manager); repo **deep-dive** in **docs/decisions/0002-consent-platform-selection.md** | **Strong**: GCM v2 + TCF on [pricing](https://www.consentmanager.net/pricing/); expect standard snippet + GTM consent wiring | **Good** (CMP positioning); less **first-party** documentation depth in-repo than Termly | **Good** (GTM + GCM documented in knowledge base) | **Confirm** in trial: GCM v2 + your **container** patterns |
| **Non-Google tags (e.g. Meta)** | **Termly.consentSaveDone** + consent checks documented | Plan on **custom** triggers; verify against your **GTM** export | Verify | Verify | Verify |
...
**Among the “Clear WL at moderate cost” list only:** choose **Termly Pro+** (**USD 15–20**/site/month, **USD 15** on annual billing).
...
2. **Implementation risk:** **Google’s** own GTM setup doc names **Termly**, and this repository already has a **Termly-specific** integration analysis (**ADR 0002** supplement), which shortens unknowns versus **consentmanager**, **CookieFirst**, **Secure Privacy**, and **Enzuzo** for **your** exact **GTM-KXJGBL5W** migration story.
3. **Price vs CookieYes Ultimate:** **Termly Pro+** undercuts **CookieYes Ultimate (~USD 55)** while meeting **WL**.
4. **Product fit:** **IAB TCF 2.3** and **GCM v2** are explicit on **Pro+**; **EU storage** story is documented for **EU** accounts.

**Runner-up:** **consentmanager.net Starter (~€23)** if you want **maximum** features per euro and accept **smaller** review N and a **busier** product (A/B tests, crawls, **whitelabel domain** option for **CSP** nerds). Run a **two-week** parallel staging check against **Termly**.

**If review average matters more than price:** **Secure Privacy Business (~USD 49)** has **strong** Trustpilot density for its size; you pay more than **Termly** or **consentmanager** at **~60k**-class traffic.
...
**Enzuzo:** viable **budget** path only after you **reproduce** the **G2** scores on the live **G2** page and complete the same **GTM + Ads + Meta** staging checklist as for Termly.
...
**docs/tracking-and-consent-requirements.md** states **GTM is mandatory** and points CMP migration work at **docs/gtm-termly-migration-runbook.md**.
