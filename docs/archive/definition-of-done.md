...
- Functional conversion path: in-repo **GTM** + **CookieConsent** embed and **Consent Mode** defaults are wired; **full** analytics and attribution validation (tags firing after consent, **Understory** **`dataLayer`**) completes in **Phase 8** (**`docs/phase-8-todo.md`** **P8-07**, **P8-22**).
...
- **Monitoring:** Post-cutover organic monitoring checklist **P9-26** is **closed** **2026-04-25** — **`docs/phase-9-verification-record.md`** §P9-26. Ongoing spot checks use the stats bridge (**`skills/performance-check/SKILL.md`** §E). Original plan: GSC coverage, traffic trend vs baseline, indexed pages, Core Web Vitals field data (see **P8-08** baseline in **`docs/phase-8-verification-record.md`**).
