# Content Model Contract v1 (archived)

**Status:** Reference only. The Astro site does not implement per-page YAML frontmatter or Elementor ids. The live contract is `docs/content-model.md`.

Purpose: define the versioned content contract for page data, shared data, and component props used during the WordPress migration (Phases 0–8).
