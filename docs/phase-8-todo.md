...
- [ ] **P8-05 Phase 7 gate (or waiver):** Phase 7 checklist (**`docs/phase-7-todo.md`**) is complete for what must ship before **`www`**, or remaining items are explicitly deferred with Gustaf approval and logged. **GTM:** full **Termly**-compatible trigger set and removal of **Complianz-only** dependence can complete here even if **P7-10** only did **Phase A** on staging (**`docs/kpi-measurement-map.md`**, **EX-0018**).
