...
| **P6-03** onward | **Next:** **P6-03** (**`de` + Berlin** chrome and **`/de/berlin/...`** bodies). Then **P6-04**–**P6-06** (metadata QA, exceptions log, Phase 6 doc closure). |

**Your next actions (Gustaf):** When **P6-03** is ready for review, approve the **Wave 3** package in **`docs/phase-6-verification-record.md`**. **Maintainer next actions:** Execute **P6-03** per the wave rules below (one route at a time, **`npm test`** / **`npm run build`** green between pages).
