...
- **Docs (`P5-06`):** Clarify **staging** entry-router checks on **`https://andetag-web.guff.workers.dev`** (push deploys); **`https://www.andetag.museum`** table **B** only at production cutover while legacy site remains live (**`docs/phase-6-todo.md`**, **`docs/grand-plan.md`**, **`docs/phase-4-redirect-tests.md`**, **`docs/phase-6-verification-record.md`**, **`AGENTS.md`**).
