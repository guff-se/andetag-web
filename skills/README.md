...
| [`seo`](seo/SKILL.md) | P9-13 | active | Gatekeeper for on-page SEO and entity graph: titles, meta descriptions, canonical, hreflang, Open Graph, Twitter cards, JSON-LD (Museum + LocalBusiness, Place, Event, FAQPage, AggregateRating), robots, sitemap, keyword framing, internal linking, tone. Binds `docs/Andetag SEO Manual.md`, `docs/Tone of Voice.md`, `docs/url-migration-policy.md`, `docs/meta-texts-catalog.md`, EX-0015/0016/0017/0019. Source integrity rules forbid fabricated URLs, keywords, ratings, prices, or schema fields. Rich Results validation is manual (live deploy). OSS lineage: structural inspiration only from MIT `coreyhaines31/marketingskills/skills/seo-audit` and `JeffLi1993/seo-audit-skill`. |
