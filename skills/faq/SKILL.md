...
4. If the new question belongs on the home accordion too, append a summarized object to `stockholmMarketingFaqSv` **and** `stockholmMarketingFaqEn`. Keep the marketing list ≤ 6 items; if it's already full, do not grow it — ask the user which existing marketing question to replace.
...
The user says: *"Change the English 'What is ANDETAG?' intro sentence to emphasize it's a sensory art museum, not an exhibition."*
